                    ...
                    <form action="{{ route('admin.subscriptions.update', $plan->id) }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <!-- Hidden input to store selected features - CHANGED to features_json -->
...
$(document).ready(function() {
    ...
    // Load existing features for editing
    @if(isset($plan) && $plan->features)
        // Handle features properly - could be array or JSON string
        let existingFeatures = {!! json_encode($plan->features) !!};
        ...
        selectedFeatures = Array.isArray(existingFeatures) ? existingFeatures : [];
